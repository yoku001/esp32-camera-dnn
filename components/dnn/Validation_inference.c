...
typedef struct {
    ...
    int v6_shape[4];
    rt_variable_t v7; ///< depthwise_conv/W
    int v7_shape[3];
    rt_variable_t v8; ///< depthwise_conv/b
    int v8_shape[1];
    rt_variable_t v9; ///< DepthwiseConvolution_Output
    int v9_shape[4];
    rt_variable_t v10; ///< conv2/conv/W
    int v10_shape[4];
    rt_variable_t v11; ///< conv2/conv/b
    int v11_shape[1];
    rt_variable_t v12; ///< Convolution_2_Output
    int v12_shape[4];
    rt_variable_t v13; ///< MaxPooling_2_Output
    int v13_shape[4];
    rt_variable_t v14; ///< ReLU_2_Output
    int v14_shape[4];
    rt_variable_t v15; ///< fc3/affine/W
    int v15_shape[2];
    rt_variable_t v16; ///< fc3/affine/b
    int v16_shape[1];
    rt_variable_t v17; ///< Affine_Output
    int v17_shape[2];
    rt_variable_t v18; ///< ReLU_3_Output
    int v18_shape[2];
    rt_variable_t v19; ///< fc4/affine/W
    int v19_shape[2];
    rt_variable_t v20; ///< fc4/affine/b
    int v20_shape[1];
    rt_variable_t v21; ///< Affine_2_Output
    int v21_shape[2];
    rt_variable_t v22; ///< y
    int v22_shape[2];
    ...
    rt_function_t f4; ///< DepthwiseConvolution
    rt_variable_t* f4_inputs[3];
    rt_variable_t* f4_outputs[1];
    depthwise_convolution_local_context_t *f4_local_context;
    ...
    rt_function_t f6; ///< MaxPooling
    rt_variable_t* f6_inputs[1];
    rt_variable_t* f6_outputs[1];
    max_pooling_local_context_t *f6_local_context;
    ...
    rt_function_t f11; ///< Softmax
    rt_variable_t* f11_inputs[1];
    rt_variable_t* f11_outputs[1];
    softmax_local_context_t *f11_local_context;
...
void* nnablart_validation_allocate_context(void** params)
{
    ...
    if(params) {
        ...
        c->param_pool[0] = *params++;
        c->param_pool[0] = malloc(sizeof(float) * 72);
        ...
        c->param_pool[2] = *params++;
        c->param_pool[2] = malloc(sizeof(float) * 72);
        ...
        c->param_pool[4] = *params++;
        c->param_pool[4] = malloc(sizeof(float) * 64);
    ...
    c->f4_local_context = malloc(sizeof(depthwise_convolution_local_context_t));
    ...
    (c->f4_local_context)->multiplier = 1;
    allocate_depthwise_convolution_local_context(&(c->f4));
    // Convolution
    ...
    // MaxPooling
    c->f6_local_context = malloc(sizeof(max_pooling_local_context_t));
    (c->f6).num_of_inputs = 1;
    (c->f6_inputs)[0] = &(c->v12);
    (c->f6).inputs = c->f6_inputs;
    (c->f6).num_of_outputs = 1;
    (c->f6_outputs)[0] = &(c->v13);
    ...
    allocate_max_pooling_local_context(&(c->f6));
    // ReLU
    ...
    (c->f10_inputs)[1] = &(c->v19);
    (c->f10_inputs)[2] = &(c->v20);
    (c->f10).inputs = c->f10_inputs;
    (c->f10).num_of_outputs = 1;
    (c->f10_outputs)[0] = &(c->v21);
    ...
    // Softmax
    c->f11_local_context = malloc(sizeof(softmax_local_context_t));
    (c->f11).num_of_inputs = 1;
    (c->f11_inputs)[0] = &(c->v21);
    (c->f11).inputs = c->f11_inputs;
    (c->f11).num_of_outputs = 1;
    (c->f11_outputs)[0] = &(c->v22);
    (c->f11).outputs = c->f11_outputs;
    (c->f11).local_context = c->f11_local_context;
    (c->f11_local_context)->axis = 1;
    allocate_softmax_local_context(&(c->f11));
    return (void*)c;
}
...
int nnablart_validation_free_context(void* context)
{
    ...
    free_depthwise_convolution_local_context(&(c->f4));
    ...
    free_max_pooling_local_context(&(c->f6));
    ...
    free_softmax_local_context(&(c->f11));
...
float* nnablart_validation_param_buffer(void* context, int index)
{
    ...
    switch(index) {
        ...
        case 2: return (c->v10).data;
        case 3: return (c->v11).data;
        case 4: return (c->v7).data;
        case 5: return (c->v8).data;
        case 6: return (c->v15).data;
        case 7: return (c->v16).data;
        case 8: return (c->v19).data;
        case 9: return (c->v20).data;
    }
    return 0;
}
int nnablart_validation_inference(void* context)
{
    ...
    exec_relu(&(c->f3));
    exec_depthwise_convolution(&(c->f4));
    exec_convolution(&(c->f5));
    exec_max_pooling(&(c->f6));
    exec_relu(&(c->f7));
    exec_affine(&(c->f8));
    exec_relu(&(c->f9));
    exec_affine(&(c->f10));
